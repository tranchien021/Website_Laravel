						...
						<div id="full-slider-wrapper">
							<div id="layerslider" style="width:100%;height:450px; ">
								...
								<div class="ls-slide" data-ls="transition3d:all; timeshift:-1000; slidedelay: 7000;">
									...
									<img  src="{{url('site')}}/img/resource/main-slide3.jpg" class="ls-bg" alt="Slide background"/>
								...
								<div class="ls-slide" data-ls="transition3d:all; timeshift:-1000; slidedelay: 7000;">
									...
									<img  src="{{url('site')}}/img/resource/main-slide2.jpg" class="ls-bg" alt="Slide background"/>
								...
								<div class="ls-slide" data-ls="transition3d:all; timeshift:-1000; slidedelay: 6000;">
									...
									<img  src="{{url('site')}}/img/resource/main-slide1.jpg" class="ls-bg" alt="Slide background"/>
				...
				<div class="row">
					...
					<div class="col-md-3 col-xs-6 helix-product clearfix">
						<div class="img-wrapper">
							<img src="{{url('site')}}/img/shop/img-7.jpg" alt="" class="img-responsive">
						</div>
					...
					<div class="col-md-3 col-xs-6 helix-product clearfix">
						<div class="img-wrapper">
							<img src="{{url('site')}}/img/shop/img-9.jpg" alt="" class="img-responsive">
						</div>
						<div class="product-detail">
							<a href="#"><h3>Ball</h3></a>
							<h4>$29.00</h4>
					...
					<div class="col-md-3 col-xs-6 helix-product clearfix">
						<div class="img-wrapper">
							<img src="{{url('site')}}/img/shop/img-11.jpg" alt="" class="img-responsive">
						</div>
						<div class="product-detail">
			...
			<div id="shop-all" class="row">
				...
				<div class="col-xs-12 col-sm-6 col-md-3 product-item filter-best">
					<div class="product-img">
						<img src="{{url('site')}}/img/shop/index3_product1.png" alt="product">
					...
					<div class="recent-items">
						...
						<div class="owl-carousel" data-items="5" data-auto-play="true" data-pagination="true" data-single-item="false">
							...
							<div class="owl-content">
								...
								<div class="product-item filter-best">
									<div class="product-img">
										<img src="{{url('site')}}/img/shop/index3_product2.png" alt="product">
										<div class="product-hover">
											<div class="product-cart">
												<a class="btn btn-secondary btn-block" href="#">Add To Cart</a>
											</div>
							...
							<div class="owl-content">
								...
								<div class="product-item filter-best">
									<div class="product-img">
										<img src="{{url('site')}}/img/shop/index3_product3.png" alt="product">
										<div class="product-hover">
											<div class="product-cart">
												<a class="btn btn-secondary btn-block" href="#">Add To Cart</a>
											</div>
							...
							<div class="owl-content">
								...
								<div class="product-item filter-best">
									<div class="product-img">
										<img src="{{url('site')}}/img/shop/index3_product4.png" alt="product">
										<div class="product-hover">
											<div class="product-cart">
												<a class="btn btn-secondary btn-block" href="#">Add To Cart</a>
											</div>
							...
							<div class="owl-content">
								...
								<div class="product-item filter-best">
									<div class="product-img">
										<img src="{{url('site')}}/img/shop/index3_product5.png" alt="product">
										<div class="product-hover">
											<div class="product-cart">
												<a class="btn btn-secondary btn-block" href="#">Add To Cart</a>
											</div>
							...
							<div class="owl-content">
								...
								<div class="product-item filter-best">
									<div class="product-img">
										<img src="{{url('site')}}/img/shop/index3_product6.png" alt="product">
										<div class="product-hover">
											<div class="product-cart">
												<a class="btn btn-secondary btn-block" href="#">Add To Cart</a>
											</div>
							...
							<div class="owl-content">
								...
								<div class="product-item filter-best">
									<div class="product-img">
										<img src="{{url('site')}}/img/shop/index3_product7.png" alt="product">
										<div class="product-hover">
											<div class="product-cart">
												<a class="btn btn-secondary btn-block" href="#">Add To Cart</a>
											</div>
							...
							<div class="owl-content">
								...
								<div class="product-item filter-best">
									<div class="product-img">
										<img src="{{url('site')}}/img/shop/index3_product8.png" alt="product">
										<div class="product-hover">
											<div class="product-cart">
												<a class="btn btn-secondary btn-block" href="#">Add To Cart</a>
											</div>
			...
			<div class="row">
				<div class="Last-items-shop col-md-3">
					...
					<div class="Last-post">
						<ul class="shop-res-items">
							<li>
								<a href="#"><img src="{{url('site')}}/img/small/50.jpg" alt=""></a>
								<h6><a href="#">Stockholm Chair high Mosta gruancy</a></h6>
								<span class="sale-date">$28.00</span>
							</li>
							<li>
								<a href="#"><img src="{{url('site')}}/img/small/51.jpg" alt=""></a>
								<h6><a href="#">Stockholm Chair high Mosta gruancy</a></h6>
								<span class="sale-date">$40.00</span>
							</li>
							<li>
								<a href="#"><img src="{{url('site')}}/img/small/52.jpg" alt=""></a>
								<h6><a href="#">Stockholm Chair high Mosta gruancy</a></h6>
				...
				<div class="Last-items-shop col-md-3">
					...
					<div class="Last-post">
						<ul class="shop-res-items">
							<li>
								<a href="#"><img src="{{url('site')}}/img/small/53.jpg" alt=""></a>
								<h6><a href="#">Stockholm Chair high Mosta gruancy</a></h6>
								<span class="sale-date">$28.00</span>
							</li>
							<li>
								<a href="#"><img src="{{url('site')}}/img/small/54.jpg" alt=""></a>
								<h6><a href="#">Stockholm Chair high Mosta gruancy</a></h6>
								<span class="sale-date">$40.00</span>
							</li>
							<li>
								<a href="#"><img src="{{url('site')}}/img/small/55.jpg" alt=""></a>
								<h6><a href="#">Stockholm Chair high Mosta gruancy</a></h6>
								<span class="sale-date">$150.00</span>
							</li>
						</ul>
				...
				<div class="Last-items-shop col-md-3">
					...
					<div class="Last-post">
						<ul class="shop-res-items">
							<li>
								<a href="#"><img src="{{url('site')}}/img/small/56.jpg" alt=""></a>
								<h6><a href="#">Stockholm Chair high Mosta gruancy</a></h6>
								<span class="sale-date">$28.00</span>
							</li>
							<li>
								<a href="#"><img src="{{url('site')}}/img/small/57.jpg" alt=""></a>
								<h6><a href="#">Stockholm Chair high Mosta gruancy</a></h6>
								<span class="sale-date">$40.00</span>
							</li>
							<li>
				...
				<div class="Last-items-shop col-md-3">
					...
					<div class="Last-post">
						<ul class="shop-res-items">
							...
							<li>
								<a href="#"><img src="{{url('site')}}/img/small/58.jpg" alt=""></a>
								<h6><a href="#">Stockholm Chair high Mosta gruancy</a></h6>
								<span class="sale-date">$40.00</span>
							</li>
							<li>
