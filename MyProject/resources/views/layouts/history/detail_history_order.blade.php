          ...
          "enabled": true
                    ...
                    <tbody>
                        ...
                        <tr data-expanded="true" class="color_qty_{{$details->product_id}}">
                            ...
                            <td>
                                <input readonly {{$order_status==2 ? 'disabled' : ''}} class="order_qty_{{$details->product_id}}" name="product_sale_quantity" type="number" value="{{$details->product_sale_quantity}}" min="1">
                        ...
                        <tr>
                            <td colspan="5">
                                ...
                                <h3>Tổng tiền : {{number_format($total_coupon,0,',','.')}} đ</h3>  </td>
                        </tr>
