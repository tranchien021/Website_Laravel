            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                            ...
                            <table class="table table-clear">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="right">{{$shipping_array['money_ship']}}</td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="right">
                                            <strong>{{number_format($total+$shipping_array['money_ship'],0,',','.')}}</strong>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                        ...
                        <h3>Chúng tôi đã xác nhận và tiến hành giao, sản phẩm sẽ được gửi trong thời gian ngắn nhất </h3>
                        <p>Xem lịch sử đơn hàng <a target="_blank" href="{{url('/history_order')}}">  tại đây </a></p>
