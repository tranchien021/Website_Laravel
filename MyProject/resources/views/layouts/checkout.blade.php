						...
						<div class="bill-to">
							...
							<div class="form-one" style="width:60%;" >
								<form  method="POST">
									...
									<textarea name="shipping_notes" class="shipping_notes"  placeholder="Những lưu ý khi gửi" rows="5"></textarea>
									...
									<div class="">
										<div class="form-group ">
											<label for="comment" class="control-label col-lg-3">Chọn hình thức thanh toán  </label>
