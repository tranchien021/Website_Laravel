                    ...
                    @endif
                        ...
                        <div class="panel-body">
                            <div class=" form">
                                ...
                                <form class="cmxform form-horizontal " id="commentForm" action="{{url('/admin/update_blog/'.$data->blog_id)}}" method="POST" novalidate="novalidate" enctype="multipart/form-data">
                                 @csrf
                                    <div class="form-group ">
                                        <label for="cname" class="control-label col-lg-3">Tên bài viết  </label>
                                        <div class="col-lg-6">
                                            <input  value="{{$data->blog_title}}" class=" form-control" id="slug" onkeyup="ChangeToSlug();" name="blog_title" minlength="2" type="text" required="">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="curl" class="control-label col-lg-3"> Slug  </label>
                                        <div class="col-lg-6">
                                            <textarea style="resize:none" class="form-control " id="convert_slug" name="blog_slug">{{$data->blog_slug}}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="curl" class="control-label col-lg-3"> Tóm tắt bài viết  </label>
                                        <div class="col-lg-6">
                                            <textarea style="resize:none" class="form-control " name="blog_desc">{{$data->blog_desc}}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="curl" class="control-label col-lg-3"> Nội dung bài viết  </label>
                                        <div class="col-lg-6">
                                            <textarea id="edit_blog_content" style="resize:none" class="form-control " name="blog_content">{{$data->blog_content}}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="curl" class="control-label col-lg-3"> Meta từ khoá  </label>
                                        <div class="col-lg-6">
                                            <textarea style="resize:none" class="form-control " name="blog_meta_keywords">{{$data->blog_meta_keywords}}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="curl" class="control-label col-lg-3"> Meta nội dung  </label>
                                        <div class="col-lg-6">
                                            <textarea style="resize:none" class="form-control " name="blog_meta_desc">{{$data->blog_meta_desc}}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group ">
